 ...
 * Modern Admin Theme 
 * 
 * @author PPO <info@ppo.vn>
 * @link http://ppo.vn
 * @copyright (c) PPO
 * 
 * Based on the original Modern Admin plugin version 1.6 - Copyright (C) WPPrime
 */
...
class modern_admin_ui{
    ...
    public function __construct(){
        ...
        /* on localhost */
        //$this->pluginURL = get_template_directory_uri() . str_replace("\\", "/", str_replace(str_replace("/", "\\", get_template_directory()),"", dirname( __FILE__ ))) . "/";
        /* on server */
        $this->pluginURL = get_template_directory_uri() . str_replace(get_template_directory(),"", dirname( __FILE__ )) . "/";
